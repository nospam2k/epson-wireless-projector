...
class Main {
    ...
    @SuppressWarnings("FieldCanBeLocal")
    private byte[] baSearchUDP = new byte[] {0x45, 0x45, 0x4d, 0x50, 0x30, 0x31, 0x30, 0x30, // EEMP0100
    ...
    private byte[] baConnectTPC = new byte[] {0x45, 0x45, 0x4d, 0x50, 0x30, 0x31, 0x30, 0x30, // EEMP0100
            0x00, 0x00, 0x00, 0x00,  // PC Ip address
    ...
    private byte[] baKeepAliveTCP = new byte[] { 0x45, 0x45, 0x4d, 0x50, 0x30, 0x31, 0x30, 0x30, // EEMP0100
            0x00, 0x00, 0x00, 0x00, // PC Ip address
            0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

    // TCP control packet - Disconnect
    private byte[] baDisconnectTCP = new byte[] {0x45, 0x45, 0x4d, 0x50, 0x30, 0x31, 0x30, 0x30, // EEMP0100
            0x00, 0x00, 0x00, 0x00, // PC Ip address
            0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};


    // TCP image packet - Init
    private byte[] baPreImage = new byte[]{0x45, 0x50, 0x52, 0x44, 0x30, 0x36, 0x30, 0x30, //EPRD0600
            0x00, 0x00, 0x00, 0x00, // PC Ip address
    ...
    private byte[] baHeader = new byte[]{0x00, 0x00, 0x00,
            0x01,                                  // Number of images in packet
    ...
    // NOTE the above header can be repeated leaving off the first 4 bytes as such:
    //    full baHeader with 4 byte set to number of images - image1  - baHeader minus 4 bytes - image2...
    //    ending with an image. Experiment with this is you want to attempt a VNC style motion display.
    ...
    private void sendImageToEpsonProjector() {
        try {
            ...
            // fragments and append to image packet (see info above on packets) but for the demo only one
            // image is used
